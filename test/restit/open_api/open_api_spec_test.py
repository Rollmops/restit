        ...
        self.assertEqual(
            {
                "schemas": {
                    "MyRequestBodySchema": {
                        ...
                        "properties": {
                            "field1": {"type": "string", "description": "Description for field1", "pattern": "\\w+"},
                            "field2": {
                                "type": "integer",
        ...
        self.assertEqual(
            {
                ...
                "requestBody": {
                    ...
                    "required": True,
                    "content": {
                        "application/json": {"schema": {"$ref": "#/components/schemas/MyRequestBodySchema"}},
                        "image/png": {
                            "schema": {
                                "type": "string",
        ...
        self.assertIn(
            {
                ...
                "required": True,
                "description": "",
                "schema": {"type": "integer", "description": "An integer field."},
            },
